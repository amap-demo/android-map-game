...
import com.amap.map3d.demo.opengl.ms3dmodel.MS3DMapRender;
import com.amap.map3d.demo.opengl.objmodel.MapRenderer;

/**
 * AMap地图中介绍如何使用OPengl
 */
public class MS3DModelActivity extends android.app.Activity  {
    ...
    private void init() {
        ...
        if (aMap == null) {
            ...
            //初始化renderer
            renderer = new MS3DMapRender(aMap,this);
