...
//材质信息
public class MS3DMaterial_GL10 {
	String name;		//材质名称
	...
	private MS3DMaterial_GL10() {}
	//加载材质信息的方法
	public final static MS3DMaterial_GL10[] load(SmallEndianInputStream is, TextureManager_GL10 manager) throws IOException{
		int count = is.readUnsignedShort();//读取材质数量
		//创建材质信息对象数组
		MS3DMaterial_GL10[] mals = new MS3DMaterial_GL10[count];
		for(int i=0; i<count; i++){//循环加载每个材质的信息
			MS3DMaterial_GL10 mal = new MS3DMaterial_GL10();
