...
import com.amap.map3d.demo.opengl.ms3dmodel.ms3d.MS3DMaterial;
 ...
 */
public class TigerModelGL20 extends MS3DModel {
    ...
    private TigerModelGL20(Context context) {
        super(context);
    }

    public static MS3DModel cloneModel(MS3DModel ms3dModel, Context context){
        TigerModelGL20 model = null;
        model = new TigerModelGL20(context);
        ...
        model.materials = ms3dModel.materials.clone();//MS3DMaterial.load(fis, manager);//加载材质信息
    ...
    public static MS3DModel loadTiger(InputStream is, TextureManager manager, Context context){
        TigerModelGL20 model = null;
